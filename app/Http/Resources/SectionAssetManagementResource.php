...
class SectionAssetManagementResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'sub_folders_count' => $this->filtered_section_folder_count??0,
            ...
            'assets'            => AssetManagementResource::collection($this->whenLoaded('assets')),
