...
use App\Models\AdditionaLinks;
use App\Models\Portals;
use Illuminate\Validation\Rule;
use Illuminate\Foundation\Http\FormRequest;

class ExternalLinkUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'link_icon' => 'file|mimes:jpg,jpeg,png,svg,webp|max:1048',
            "is_link_icon"=>"required",
