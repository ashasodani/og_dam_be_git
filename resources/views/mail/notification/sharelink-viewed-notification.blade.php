                    ...
                    <tr>
                        <td class="content-inner">
                           <!--  <h1>{{ $data['title'] ?? 'Notification from DeGeest' }}</h1> -->
                            ...
                            <p style="margin-top: 0; margin-bottom: 16px;">The Sharelink {{ $data['nmeOfObject'] }} has been viewed by {{$data['loginUser']?? 'User'}}.
                                You can review the details at your earliest convenience.
                            </p>
