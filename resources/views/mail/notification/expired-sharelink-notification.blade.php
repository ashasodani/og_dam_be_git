                    ...
                    <tr>
                        <td class="content-inner">
                           <!--  <h1>{{ $data['title'] ?? 'Notification from DeGeest' }}</h1> -->
                            ...
                            <p style="margin-top: 0; margin-bottom: 16px;"> This is a reminder that the share link {{ $data['nmeOfObject'] }} will expire in the next 24 hours.
                               If you wish to extend its availability, please take action before it expires.
                            </p>
