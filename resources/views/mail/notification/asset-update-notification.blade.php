                    ...
                    <tr>
                        <td class="logo-section">
                            <table>
                                <tr>
                                    <td class="logo">
                                        <img height="50px" width="50px" src="{{ asset('images/logo.jpg') }}" alt="">
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td class="content-inner">
                           <!--  <h1>{{ $data['title'] ?? 'Notification from DeGeest' }}</h1> -->
                            ...
                            <p style="margin-top: 0; margin-bottom: 16px;">
                                The asset - {{ $data['nmeOfObject'] }} has been updated by {{ $data['loginUser'] }}.</p>
                            <p style="margin-top: 0; margin-bottom: 16px;">You can review the updated asset at your convenience.
                            </p>
